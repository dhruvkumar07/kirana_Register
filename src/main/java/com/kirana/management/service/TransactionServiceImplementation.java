/**
 * The {@code TransactionServiceImplementation} class implements the {@code TransactionService} interface
 * and provides the concrete implementation of transaction-related business logic in the Kirana Management System.
 ...
 * - {@code inr_usd_conversion}: Performs INR to USD currency conversion using an external API.
 * <p>
 * Dependencies are injected using the {@code Autowired} annotation, and the {@code TransactionRepository}
 * and {@code StoreOwnerRepository} are used to interact with the data layer.
 * <p>
 * External API for currency conversion is accessed using the {@code HttpClient} class.
 *
 * @author Dhruv Kumar
 * @version 1.0
 * @since 2024-01-04
...
public class TransactionServiceImplementation implements TransactionService{
     ...
     *
     * @return JSON response containing currency exchange rates.
     ...
     * @return The corresponding transaction data transfer object.
     */
